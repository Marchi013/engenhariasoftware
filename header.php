  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Idealizar Imóveis</div>
      </a>
 ...
 <li class="nav-item active">
  ...
  <?php if ($_SESSION['autenticado'] === 'admin@gmail.com'){
     echo '<li class="nav-item active">
        <a class="nav-link" href="corret.php">
          <i class="fas fa-fw fa-cog"></i>
          <span>Cadastrar Corretor</span></a>
      </li>';
    } ?> 
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> <?php echo $_SESSION['autenticado'] ?> </span>
              </a>
            </li>
          </ul>
        </nav>
